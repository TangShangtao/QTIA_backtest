...
void SimpleMatcher::MatchOneBuyDeque(std::deque<OrderSPtr>& deque, const std::array<Depth, MAX_DEPTH_LEVEL>& asks)
{
...
void SimpleMatcher::MatchOneSellDeque(std::deque<OrderSPtr>& deque, const std::array<Depth, MAX_DEPTH_LEVEL>& bids)
{
