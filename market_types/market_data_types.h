...
#ifndef CRYPTO_BACKTEST_CPP_MARKET_DATA_TYPES_H
#define CRYPTO_BACKTEST_CPP_MARKET_DATA_TYPES_H
...
namespace executor {
    ...
    template <size_t N>
    struct DepthImpl {
        static constexpr  std::size_t klevel{N};
...
#endif //CRYPTO_BACKTEST_CPP_MARKET_DATA_TYPES_H
